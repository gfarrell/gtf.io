...
content currentPath =
  Just
    ...
    $ toHtmlRaw
      ...
      The site is hosted on a [Digital Ocean](https://www.digitalocean.com) droplet. I have used Digital Ocean since about 2014, and continue to do so mostly out of habit. Everything is written using [neovim](https://neovim.io) on [my machine](/codices/anaximander) which runs [archlinux (btw)](https://archlinux.org).
